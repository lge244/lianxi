	...
	<form class="layui-form" style="margin-top: 10px;">
		...
		<div style="float: left;width: 800px;">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<select name="cid" lay-filter="cid">
						...
						<option value="{$cate.id}" <?php if($product['cid']==$cate['id']){echo 'selected';}?>>{$cate.title}</option>
						{/volist}
					</select>
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="number" class="layui-input" name="price" value="{$product.price}">
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<textarea rows="10" cols="50" id="desc">{$product.desc}</textarea>
