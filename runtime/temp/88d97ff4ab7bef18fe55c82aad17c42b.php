<?php /*a:1:{s:59:"D:\phpStudy\WWW\admin\application\admins\view\admin\add.php";i:1525835556;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title></title>
...
<body style="padding: 10px;">
	<form class="layui-form">
		<input type="hidden" name="id" value="<?php echo htmlentities($data['item']['id']); ?>">
		<div class="layui-form-item">
			<label class="layui-form-label">用户名</label>
			<div class="layui-input-inline">
				<input type="text" class="layui-input" name="username" value="<?php echo htmlentities($data['item']['username']); ?>" <?php echo $data['item']['id']>0 ? 'readonly' : ''; ?>>
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<select name="gid">
					...
					<option value="<?php echo htmlentities($vo['gid']); ?>" <?php echo $vo['gid']==$data['item']['gid'] ? 'selected'  :  ''; ?>><?php echo htmlentities($vo['title']); ?></option>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" class="layui-input" name="truename" value="<?php echo htmlentities($data['item']['truename']); ?>">
			</div>
		</div>
