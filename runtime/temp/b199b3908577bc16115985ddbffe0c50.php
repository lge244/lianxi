<?php /*a:1:{s:70:"D:\phpStudy\PHPTutorial\WWW\admin\application\admins\view\news\add.php";i:1533883936;}*/ ?>
<!DOCTYPE html>
<html>
<head>
		...
		<div style="float: left;width: 800px;">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<textarea rows="10" cols="50" id="content"><?php echo htmlentities($product['content']); ?></textarea>
				</div>
			</div>
			<div class="layui-form-item">
